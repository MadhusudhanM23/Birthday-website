...
let settings = {
    music: './music/WhatsApp Audio 2026-03-31 at 6.58.23 PM.mpeg',
    countdown: 3,
    matrixText: 'HAPPYBIRTHDAY',
    matrixColor1: '#D4AF37', // Gold color
    matrixColor2: '#003366', // Royal Blue color
    sequence: 'HAPPY|BIRTHDAY|TO|YOU|CHANDAN|❤',
    sequenceColor: '#D4AF37', // Gold color
    gift: '', // No sticker/GIF
    pages: [
